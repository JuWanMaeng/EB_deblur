...
datasets = ['my']
# datasets = ['FB_Restormer_RealBlur_J_410k']

for dataset in datasets:

    file_path = os.path.join('/workspace/FFTformer/results' , dataset)
    gt_path = os.path.join('/workspace/data/Realblur_test', 'RealBlur_J', 'target')
    ...
    path_list = ['/workspace/FFTformer/results/my/scene122-8.png']
    gt_list = ['/workspace/data/Realblur_test/RealBlur_J/target/scene122-8.png']
