...
def main():
    ...
    # automatic resume ..
    state_folder_path = '/workspace/data/Restormer/experiments/{}/training_states/'.format(opt['name'])
    opt['path']['log'] = '/workspace/data/Restormer/experiments/{}'.format(opt['name'])
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            if 'flow2' in train_data.keys():
                flow2 = train_data['flow2']
                lq = torch.cat([flow2,lq,flow], dim=(1))

            else:

                lq = torch.cat([lq,flow],dim=(1))
